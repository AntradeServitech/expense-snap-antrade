...
const SECTIONS = [
  {
    ...
    fields: [
      ...
      { name: 'x_tf430_battery_voltage', ori: 'x_tf430_battery_voltage_ori', label: 'Tension de bateria (Vdc)',                                      type: 'char' },
      { name: 'x_tf430_throttle_signal', ori: 'x_tf430_throttle_signal_ori', label: 'Senal del acelerador (tipo y rango de voltaje)',                type: 'char' },
      { name: 'x_tf430_start_stop_pins', ori: 'x_tf430_start_stop_pins_ori', label: 'Pines arranque/parada del diesel (descripcion)',                type: 'char' },
      { name: null,                       ori: 'x_tf430_diesel_3d_plan_ori',  label: 'Plano 3D del diesel/volante de inercia (archivo)',              type: 'binary', fileName: 'x_tf430_diesel_3d_plan' },
      { name: null,                       ori: 'x_tf430_gearbox_3d_plan_ori', label: 'Plano 3D de la reductora (archivo)',                            type: 'binary', fileName: 'x_tf430_gearbox_3d_plan' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'x_7324_eng_firing_angle', ori: 'x_7324_eng_firing_angle_ori', label: 'Angulo de encendido por cilindro (grados)',                      type: 'char' },
